...
class DocsHelper
{
    ...
    {
        $path = resource_path('laravel-common/readme');
        if (!File::isDirectory($path))
            $path = __DIR__ . '/../../resources/laravel-common/readme';
    ...
    {
        $path = resource_path('laravel-common/readme/' . $key);
        if (!File::exists($path))
            $path = __DIR__ . '/../../resources/laravel-common/readme/' . $key;
        return [
